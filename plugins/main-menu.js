...
const vid = 'https://ibb.co/qYFqbjV0';
...
/* await conn.sendMessage(m.chat, { video: { url: vid }, caption: text.trim(), contextInfo: { mentionedJid: [m.sender], isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: channelRD.id, newsletterName: channelRD.name, serverMessageId: -1, }, forwardingScore: 999, externalAdReply: { title: textbot, body: dev, thumbnailUrl: 'https://qu.ax/yxlvU.jpg', sourceUrl: redes, mediaType: 1, renderLargerThumbnail: false,
}, }, gifPlayback: true, gifAttribution: 0 }, { quoted: null }) */

let img = 'https://raw.githubusercontent.com/ArmPg-01/KiroBot2.0/main/media/catalogo.jpg'; // valiendo vrg con los links
